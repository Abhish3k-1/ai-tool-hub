    ...
    return (
        <Link href={href} className="group block h-full">
            <div className="hover-lift interactive-ripple relative flex h-full flex-col overflow-hidden rounded-3xl border border-slate-200/70 bg-white/82 p-6 shadow-[0_10px_24px_rgba(15,23,42,0.07)] backdrop-blur-xl dark:border-slate-800/50 dark:bg-slate-900/60 dark:shadow-[0_15px_30px_rgba(0,0,0,0.4)]">
                ...
                <h3 className="relative mb-2 text-xl font-semibold text-slate-900 transition-colors group-hover:text-sky-700 dark:text-slate-100 dark:group-hover:text-sky-400">
                    {title}
                </h3>

                <p className="relative flex-grow text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                    {description}
                </p>

                <div className="relative mt-6 flex items-center text-sm font-semibold text-sky-700 opacity-90 transition-opacity group-hover:opacity-100 dark:text-sky-400">
